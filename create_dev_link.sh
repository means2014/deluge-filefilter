...
CONFIG_DIR=$( test -z $1 && echo "/home/chris/.config/deluge" || echo "$1")
...
/home/chris/miniconda3/envs/FilterFiles/bin/python setup.py build develop --install-dir $BASEDIR/temp
